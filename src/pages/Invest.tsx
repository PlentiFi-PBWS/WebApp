...
const Invest = () => {
    ...
    const selectedAsset = AVAILABLE_TOKENS.find(token => token.ticker === asset);
    ...
    <div>
      ...
      <div className="containerd">
        <div className="tokenName">
          ...
          <span className="star" onClick={toggleFavorite} style={{ cursor: 'pointer', color: isFavorited ? 'orange' : 'grey' }}>
